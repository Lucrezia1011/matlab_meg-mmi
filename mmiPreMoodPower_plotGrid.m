...
%     saveas(gcf,sprintf('~/matlab/figures/%s_gamma_peak_%s_2e3perms.png',fit_parameter,muname))
    ...
    ft_sourceplot(cfg, sourceout_Int);
%     saveas(gcf,sprintf('~/matlab/figures/%s_gamma_slice_%s_2e3perms.png',fit_parameter,muname))
end
% close all
end
