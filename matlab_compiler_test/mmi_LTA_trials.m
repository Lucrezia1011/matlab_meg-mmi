function mmi_LTA_trials(meg_data_name,latent_vars_name,n,npoints,fit_parameter,outpathn,data_path)
...
for z = 1:npoints
    ...
    % G = fitglm(X,['MEG ~ ',fit_parameter,' + subject'],'CategoricalVars','subject');
