...
% meg_data_names = {'positive_aal_mu5max_Z.txt';'negative_aal_mu5max_Z.txt';...
%     'posneg_aal_mu5max_Z.txt'};
...
file_handle = fopen(sprintf('mmi_LTA_subjects_%s.swarm',freq),'w+');
