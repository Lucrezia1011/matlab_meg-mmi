...
samples_cut = 1:(length(time)-nnz(BadSamples));
indN = true(1,length(time));
...
pix_time = time(pix_sample); %  - time.trial{1}(1)
% 
...
if ~isempty(rest_sample)
    ...
    % behavioral files.
    rest_diff = bv_rest - time(rest_sample);
    ...
    while match_check
        ...
        for ii = 1:length(pix_sample)
            ...
            if mm < w
                ...
                answer_match.sample(nn) = samples_T(pix_sample(ii));
            ...
            if mm < w
                ...
                choice_match.sample(nn) = samples_T(pix_sample(ii));
            ...
            if mm < w
                ...
                outcome_match.sample(nn) = samples_T(pix_sample(ii));
            ...
            if mm < w
                ...
                ITI_match.sample(nn) = samples_T(pix_sample(ii)-2*f);
                %             if strcmp(bv.outcome{jj},'win')
                %                 ITI_match.win(nn) = 1;
                %             elseif strcmp(bv.outcome{jj},'lose')
                %                 outcome_match.win(nn) = -1;
            ...
            if mm < w
                ...
                slider_match.sample(nn) = samples_T(pix_sample(ii));
            ...
            if mm < w
                ...
                blockslider_match.sample(nn) = samples_T(pix_sample(ii));
            ...
            if mm < w
                ...
                mood_match.sample(nn) = samples_T(pix_sample(ii));
            ...
            if mm < w
                ...
                blockmood_match.sample(nn) = samples_T(pix_sample(ii));
