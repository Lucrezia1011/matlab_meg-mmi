function mmiAALprep(data_name,twind, roiopt, opt)
...
% choice, and/or option presentation in source space with AAL atlas (gaussian kernel)
%
...
opt = lower(opt);
fevoked = 300; % downsample to 300Hz
