function mmiButtonpressBF(data_name,freqband,mu,gridres,windLength,windWait,plotopt)
...
[datapress,ttdel] = define_trials(samples,data,bv_match.time,[0 windLength],1);
...
samples(ttdel)  = [];
[datacont,ttdel] = define_trials(samples,data,bv_match.time,windWait +[0 windLength],1);
